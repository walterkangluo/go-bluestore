...
help:
	@echo 'Management commands for go-bluestore/go-bluestore:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building go-bluestore ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/go-bluestore/go-bluestore/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/go-bluestore/go-bluestore/version.BuildDate=${BUILD_DATE}" ./...
